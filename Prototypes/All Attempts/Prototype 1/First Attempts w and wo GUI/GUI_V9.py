...
class TuringMachine():
    ...
    def __init__(self):
        self.tape = []
        self.GUI_tape_positions = [-3, -2, -1, 0, 1, 2, 3, 4, 5, 6, 7]  # positions of the tape, which will change depending on left or right (GUI)
    ...
    def saveInstructions(self):
        ...
        templist.append(str(self.cbDirection.currentText()))
    ...
    def runMachine(self):
        ...
        while current_state != "H" and len(self.tape) > 0:
            ...
            if instructionfound == True:
                ...
                self.tape[self.tape_position] = current_instruction_set[3]  # assigns new value to the tape
                print "New Value on Square: " + str(self.tape[self.tape_position])
                ...
                if current_instruction_set[2] == "R" and current_instruction_set[4] != "H":
                    ...
                    if self.tape_position < 0 or self.tape_position > len(self.tape):
                        self.final_tape()
                        print ""
                        print "<--- End of Tape --->"
    ...
    def moveLeft(self):
        ...
        if self.GUI_tape_positions[3] > -1:
            if self.GUI_tape_positions[0] > -1:
                self.lblTape0.setText(str(self.tape[self.GUI_tape_positions[0]]))
            else:
                self.lblTape0.setText("#")
            if self.GUI_tape_positions[1] > -1:
                self.lblTape1.setText(str(self.tape[self.GUI_tape_positions[1]]))
            else:
                self.lblTape1.setText("#")
            if self.GUI_tape_positions[2] > -1:
                self.lblTape2.setText(str(self.tape[self.GUI_tape_positions[2]]))
            else:
                self.lblTape2.setText("#")
            self.lblTape3.setText(str(self.tape[self.GUI_tape_positions[3]]))
            self.lblTape4.setText(str(self.tape[self.GUI_tape_positions[4]]))
            self.lblTape5.setText(str(self.tape[self.GUI_tape_positions[5]]))
            self.lblTape6.setText(str(self.tape[self.GUI_tape_positions[6]]))
            self.lblTape7.setText(str(self.tape[self.GUI_tape_positions[7]]))
