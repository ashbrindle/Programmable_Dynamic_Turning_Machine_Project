...
class StartWindow(QtGui.QMainWindow):
    ...
    def fillTape(self):
        ...
        if len(tape) >= 8:
            self.lblTape0.setText(str(tape[0]))
            self.lblTape1.setText(str(tape[1]))
            self.lblTape2.setText(str(tape[2]))
            self.lblTape3.setText(str(tape[3]))
            self.lblTape4.setText(str(tape[4]))
            self.lblTape5.setText(str(tape[5]))
            self.lblTape6.setText(str(tape[6]))
            self.lblTape7.setText(str(tape[7]))
        elif len(tape) >= 7:
            self.lblTape0.setText(str(tape[0]))
            self.lblTape1.setText(str(tape[1]))
            self.lblTape2.setText(str(tape[2]))
    ...
    def moveRight(self):
        ...
        if tape_positions[0] == -1:
            ...
            self.lblTape0.setText(str(tape[tape_positions[0]]))
            self.lblTape1.setText(str(tape[tape_positions[1]]))
            self.lblTape2.setText(str(tape[tape_positions[2]]))
            self.lblTape3.setText(str(tape[tape_positions[3]]))
            self.lblTape4.setText(str(tape[tape_positions[4]]))
            self.lblTape5.setText(str(tape[tape_positions[5]]))
            self.lblTape6.setText(str(tape[tape_positions[6]]))
            self.lblTape7.setText(str(tape[tape_positions[7]]))
    ...
    def runMachine(self):
        ...
        '''cant find the tape reference, so put tape in this class to run'''
        ...
        while current_state != "H":
            ...
            if instructionfound == True:
                ...
                tape[tape_position] = current_instruction_set[3]  # assigns new value to the tape
                print "New Value on Square: " + str(tape[tape_position])
