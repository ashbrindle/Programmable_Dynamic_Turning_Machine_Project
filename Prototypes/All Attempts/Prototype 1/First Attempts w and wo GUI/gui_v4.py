...
class StartWindow(QtGui.QMainWindow):
    ...
    def __init__(self, parent = None):
        ...
        self.setGeometry(700, 400, 455, 160)
        self.tape = ["0", "0", "0", "0", "0", "0", "#", "#"]
